    ...
    public partial class GameRoom : JobSerializer
    {
        ...
        public void EnterGame(GameObject gameObject, bool randomPos)
        {
            ...
            // 타인한테 정보 전송
            {
                ...
                BroadcastVisionCube(gameObject.CellPos, spawnPacket);
            }
        }
        ...
        public void LeaveGame(int objectId)
        {
            ...
            // 타인한테 정보 전송
            {
                ...
                BroadcastVisionCube(cellPos, despawnPacket);
            }
        }
        ...
        public void BroadcastVisionCube(Vector2Int pos, IMessage packet)
        {
        ...
        public void Unicast(Player player, IMessage packet)
        {
